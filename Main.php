		...
		<!--about#2	-->
			<div class="container-fluid bg-grey">
				<div class="row">
					...
					<div class="col-sm-8">
					<h2>Our Values</h2>
					<h4><strong>VISION:</strong> Our mission is to use this online portal for fatal accident in which police, RTO and insurance company can report at any time and any place. So we get whole detail at one place and cases of fatal accident resolved easily and one can get all the benefits in time.</h4>
			...
			<div class="row" id="login">
				<h2 style="text-align:center">LOGIN</h2>
					<div class="imgcontainer col-sm-4 ">
						 <h4 style="text-align:center">RTO</h4>
						 <a href="index.php"><img src="imgs/1_log.png" alt="RTO" class="avatar"></a>
					</div>
					<div class="imgcontainer col-sm-4 ">
						<h4 style="text-align:center">POLICE</h4>
						<a href="index1.php"><img src="imgs/2_log.jpg" alt="POLICE" class="avatar"></a>
					</div>
					<div class="imgcontainer col-sm-4 ">
						<h4 style ="text-align:center">INSURER</h4>
						<a href="index2.php"><img src="imgs/3_log.png" alt="INSURER" class="avatar"></a>
					</div>
			</div>
				...
				<h2 class="text-center">CONTACT</h2>
					<div class="row">
						<div class="col-sm-5">
						  ...
						  <p><span class="glyphicon glyphicon-phone"></span> +91 9874765467</p>
...
$con = mysqli_connect("localhost",'root',"","feedback");
	if(isset($_POST['send']))
	{
		...
		$query="INSERT INTO feedbacktb (name,email,comment) VALUES ('$name','$email','$comments')";
