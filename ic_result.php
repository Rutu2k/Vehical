...
$link = mysqli_connect("localhost", "root", "", "uiicl_db");
...
<body>
	<h1>Welcome Insurance Company</h1>
	<table class="data-table">
		<caption class="title">Accident Information</caption>
		<thead>
			<tr>
				<th>Victim name</th>
				<th>Licence no</th>
				...
				<th>Other driver's name</th>
				<th>Other vehicle registration no</th>
				<th>Other insurance company</th>
