...
<body>
	<div class="container">
		...
		<img src="imgs/pol.png" alt="RTO" width="1000" height="300">
		<a href="logout.php"><input type="submit" class="logout" name="logout" value="Log out"/>
		<div class="bottomright"></div>
	</div>
	<ul>
	  <li><a href="javascript:form1()" id="link1">Fill Information of Victim</a></li>
	  <li><a href="javascript:form2()" id="link2">Fill Report</a></li>
	</ul>
	<div class="content" id="con">
		 <?php require('vehiclepage.php'); ?>
	</div>
