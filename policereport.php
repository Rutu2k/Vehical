	...
	<body>
		<div id="main-wrapper2" align="center">
			...
			<form class="form-group" action="" method="post">
					...
					<label><b>Age</b></label>
					<input type="number" name="age" min="18"><br>
					<hr>
					<center><h3>Other drivers information</center></h3>
					<label><b>First Name</b></label>
					<input name="pr_oname" type="text" class="form-control" placeholder="Type other's first name" required/><br>
					<label><b>Middle Name<b></label>
					<input name="pr_omname" type="text" class="form-control" placeholder="Type other's middle name" required/><br>
					<label><b>Last Name<b></label>
					<input name="pr_olname" type="text" class="form-control" placeholder="Type other's last name" required/><br>
...
if(isset($_POST['policereportsend']))
{
	...
	$vrno=$_POST['pr_vrno'];
	$age=$_POST['age'];
	$ofirstname=$_POST['pr_oname'];
	$omiddlename=$_POST['pr_omname'];
	$olastname=$_POST['pr_olname'];
	...
	$query="INSERT INTO policereport (firstname,middlename,lastname,vrno,ofirstname,omiddlename,olastname,location,landmark,weather,road,light,adate,atime,wfirstname,wmiddlename,wlastname,phoneno,age) VALUES ('$firstname','$middlename','$lastname','$vrno','$ofirstname','$omiddlename','$olastname','$location','$landmark','$weather','$road','$light','$adate','$atime','$wfirstname','$wmiddlename','$wlastname','$phoneno','$age')";
