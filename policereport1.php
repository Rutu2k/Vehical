...
$con=mysqli_connect("localhost",'root',"","samplelogindb");
	...
	{ 
		while($row=mysqli_fetch_assoc($result))
		{
			...
			$adate=$row['adate'];
			$atime=$row['atime'];
			$wfirstname=$row['wfirstname'];
			$wmiddlename=$row['wmiddlename'];
			$wlastname=$row['wlastname'];
			$phoneno=$row['phoneno'];
			$age=$row['age'];
		}
	}
	...
	<body>
		...
		<div id="main-wrapper2" align="center">
			...
			<form class="form-group" action="" method="post">
					...
					<label><b>First Name</b></label>
					<input name="pr_oname" type="text" class="form-control" value='<?php echo (isset($ofirstname)) ? $ofirstname: ''; ?>'/><br>
					<label><b>Middle Name<b></label>
					<input name="pr_omname" type="text" class="form-control" value='<?php echo (isset($omiddlename)) ? $omiddlename: ''; ?>'/><br>
					<label><b>Last Name<b></label>
					<input name="pr_olname" type="text" class="form-control" value='<?php echo (isset($olastname)) ? $olastname: ''; ?>'/><br>
					<hr>
					...
					<input name="pr_weather" type="text" class="form-control" value='<?php echo (isset($road)) ? $road: ''; ?>'/><br>
					<label><b>Light conditions<b></label><br>
					<input name="pr_weather" type="text" class="form-control" value='<?php echo (isset($light)) ? $light: ''; ?>'/><br>
					...
					<hr>		
				<a href="rto_home.php"><input type="button" id="p_back_btn" value="<< Back" class="btn btn-primary btn-lg"/></a>
