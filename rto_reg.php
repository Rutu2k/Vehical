...
<html>
	...
	<body>
		...
		<img src="imgs/1_log.jpg" class="p_avatar"/>
		</center>
		<hr>
		
		<form class="r_myform" action="rto_reg.php" method="post">
			<center><h2>RTO Officer Information</h2><br></center>
			...
			<input name="r_dob" type="date" class="p_inputvalues" required/><br><hr>
			<center><h2>Regional Transport Office Information</h2><br></center>
			<label><b>Office location<b></label>
			<input name="r_location" type="text" value="pune" class="p_inputvalues" />
			<label><b>Office contact number<b></label>
		...
		<br><hr>
			...
			<a href="index.php"><input type="button" id="p_back_btn" class="btn btn-primary btn-lg btn-block" value="<< Back" /></a>
		
		</form>
		
<?php
		$connect=mysqli_connect("localhost",'root',"","rtoregdb");
		if(isset($_POST['rto_reg_btn']))
		{
			...
			$query= "INSERT INTO rtoregtb(firstname,middlename,lastname,disignation,dob,location,contactno,emailid)values('$firstname','$middlename','$lastname','$designation','$dob','$location','$contactno','$emailid')";
